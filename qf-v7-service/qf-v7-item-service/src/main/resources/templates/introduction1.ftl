					...
					<div class="clearfixLeft" id="clearcontent">
						...
						<div class="box">
							...
							<div class="tb-booth tb-pic tb-s310">
								<a href="${product.images}"><img src="${product.images}" alt="细节展示放大镜特效" rel="${product.images}" class="jqzoom" /></a>
							</div>
							<ul class="tb-thumb" id="thumblist">
								<li class="tb-selected">
									<div class="tb-pic tb-s40">
										<a href="#"><img src="${product.images}" mid="${product.images}" big="${product.images}"></a>
									</div>
								</li>
								<li>
									<div class="tb-pic tb-s40">
						...
						<div class="tb-detail-list">
							...
							<div class="tb-detail-price">
								<li class="price iteminfo_price">
									<dt>促销价</dt>
									<dd><em>¥</em><b class="sys_item_price">999.90</b>  </dd>
									<dd><em>¥</em><b class="sys_item_price"><font color="red" size="20px">新版本商品页面</font>
                                    </b>  </dd>
								</li>
